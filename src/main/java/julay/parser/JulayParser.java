...
public class JulayParser extends Parser {
	...
	public static final int
		...
		RULE_fun_decl = 4, RULE_pclass = 5, RULE_oclass = 6, RULE_proc = 7, RULE_program = 8, 
		RULE_spec = 9, RULE_pclass_body = 10, RULE_field = 11, RULE_var = 12, 
		RULE_constructor = 13, RULE_transition = 14, RULE_args = 15, RULE_arg = 16, 
		RULE_action_body = 17, RULE_guard = 18, RULE_transit = 19, RULE_error = 20, 
		RULE_var_transit = 21, RULE_effect = 22, RULE_effect_stmt = 23, RULE_effect_call = 24, 
		RULE_expr = 25, RULE_when_subject_arm = 26, RULE_when_guard_arm = 27, 
		RULE_when_pattern = 28, RULE_when_literal = 29, RULE_proc_expr = 30, RULE_value = 31, 
		RULE_fun_call = 32, RULE_struct_literal = 33, RULE_struct_field_assign = 34, 
		RULE_field_access = 35;
	private static String[] makeRuleNames() {
		return new String[] {
			"root", "import_stmt", "qualified_name", "decl", "fun_decl", "pclass", 
			"oclass", "proc", "program", "spec", "pclass_body", "field", "var", "constructor", 
			...
			"fun_call", "struct_literal", "struct_field_assign", "field_access"
		};
	}
	...
	public final PclassContext pclass() throws RecognitionException {
		...
		enterRule(_localctx, 10, RULE_pclass);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final OclassContext oclass() throws RecognitionException {
		...
		enterRule(_localctx, 12, RULE_oclass);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Pclass_bodyContext pclass_body() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_pclass_body);
		try {
			setState(147);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Action_bodyContext action_body() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_action_body);
		try {
			setState(206);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final TransitContext transit() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_transit);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Var_transitContext var_transit() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_var_transit);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(224);
	...
	public final Effect_stmtContext effect_stmt() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_effect_stmt);
		try {
			setState(240);
			_errHandler.sync(this);
	...
	public final Effect_callContext effect_call() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_effect_call);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
		...
		try {
			...
			case 7:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 7881300421641728L) != 0) );
				setState(300);
				match(RCURLY);
				}
				break;
	...
	public final When_subject_armContext when_subject_arm() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_when_subject_arm);
		try {
			setState(370);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final When_guard_armContext when_guard_arm() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_when_guard_arm);
		try {
			setState(379);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final When_patternContext when_pattern() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_when_pattern);
		try {
			setState(383);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final When_literalContext when_literal() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_when_literal);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	private Proc_exprContext proc_expr(int _p) throws RecognitionException {
		...
		int _startState = 60;
		enterRecursionRule(_localctx, 60, RULE_proc_expr, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Struct_field_assignContext struct_field_assign() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_struct_field_assign);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(439);
	...
	public final Field_accessContext field_access() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_field_access);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
