...
public class JulayParser extends Parser {
	...
	public static final int
		...
		EFFECT=48, FUN=49, INT=50, ID=51, STRING=52, WS=53, COMMENT=54, LINE_COMMENT=55;
	public static final int
		RULE_root = 0, RULE_import_stmt = 1, RULE_qualified_name = 2, RULE_decl = 3, 
		RULE_typeExpr = 4, RULE_typeParams = 5, RULE_fun_decl = 6, RULE_pclass = 7, 
		RULE_oclass = 8, RULE_proc = 9, RULE_program = 10, RULE_spec = 11, RULE_pclass_body = 12, 
		RULE_field = 13, RULE_var = 14, RULE_constructor = 15, RULE_transition = 16, 
		RULE_args = 17, RULE_arg = 18, RULE_action_body = 19, RULE_guard = 20, 
		RULE_transit = 21, RULE_error = 22, RULE_var_transit = 23, RULE_effect = 24, 
		RULE_effect_stmt = 25, RULE_effect_call = 26, RULE_expr = 27, RULE_when_subject_arm = 28, 
		RULE_when_guard_arm = 29, RULE_when_pattern = 30, RULE_when_literal = 31, 
		RULE_proc_expr = 32, RULE_value = 33, RULE_fun_call = 34, RULE_oclass_literal = 35, 
		RULE_struct_field_assign = 36, RULE_field_access = 37;
	private static String[] makeRuleNames() {
		return new String[] {
			"root", "import_stmt", "qualified_name", "decl", "typeExpr", "typeParams", 
			"fun_decl", "pclass", "oclass", "proc", "program", "spec", "pclass_body", 
			"field", "var", "constructor", "transition", "args", "arg", "action_body", 
			"guard", "transit", "error", "var_transit", "effect", "effect_stmt", 
			"effect_call", "expr", "when_subject_arm", "when_guard_arm", "when_pattern", 
			"when_literal", "proc_expr", "value", "fun_call", "oclass_literal", "struct_field_assign", 
			"field_access"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"FUN", "INT", "ID", "STRING", "WS", "COMMENT", "LINE_COMMENT"
		};
	}
	...
	public final RootContext root() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 564032285179904L) != 0)) {
				{
				setState(78);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final PclassContext pclass() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_pclass);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final OclassContext oclass() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_oclass);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Pclass_bodyContext pclass_body() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_pclass_body);
		try {
			setState(177);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Action_bodyContext action_body() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_action_body);
		try {
			setState(236);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final TransitContext transit() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_transit);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Var_transitContext var_transit() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_var_transit);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(254);
	...
	public final Effect_stmtContext effect_stmt() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_effect_stmt);
		try {
			setState(270);
			_errHandler.sync(this);
	...
	public final Effect_callContext effect_call() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_effect_call);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 7881306327246352L) != 0)) {
				{
				setState(274);
				expr(0);
				setState(279);
		...
		try {
			...
			case 7:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 7881300421641744L) != 0) );
				setState(330);
				match(RCURLY);
				}
				break;
			case 8:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 7881307400988176L) != 0) );
				setState(339);
				match(RCURLY);
				}
				break;
	...
	public final When_subject_armContext when_subject_arm() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_when_subject_arm);
		try {
			setState(400);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final When_guard_armContext when_guard_arm() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_when_guard_arm);
		try {
			setState(409);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final When_patternContext when_pattern() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_when_pattern);
		try {
			setState(413);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final When_literalContext when_literal() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_when_literal);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(415);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 5629499534214656L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Fun_callContext fun_call() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_fun_call);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Oclass_literalContext oclass_literal() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_oclass_literal);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Struct_field_assignContext struct_field_assign() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_struct_field_assign);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(469);
	...
	public final Field_accessContext field_access() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_field_access);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
