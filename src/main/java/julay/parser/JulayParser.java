...
public class JulayParser extends Parser {
	...
	public static final int
		...
		WHEN=34, IN=35, ARROW=36, IMPORT=37, PCLASS=38, OCLASS=39, PROC=40, PROGRAM=41, 
		SPEC=42, VAR=43, CONSTRUCTOR=44, TRANSITION=45, SERVICE=46, CONSUMER=47, 
		GUARD=48, TRANSIT=49, ERROR=50, EFFECT=51, FUN=52, REAL=53, INT=54, ID=55, 
		STRING=56, WS=57, COMMENT=58, LINE_COMMENT=59;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'%'", "'+'", "'-'", "'<'", "'<='", "'>'", "'>='", "'='", "'!='", "'#'", 
			"':='", "'=>'", "'if'", "'else'", "'let'", "'when'", "'in'", "'->'", 
			"'import'", "'p-class'", "'o-class'", "'proc'", "'program'", "'spec'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"IN", "ARROW", "IMPORT", "PCLASS", "OCLASS", "PROC", "PROGRAM", "SPEC", 
	...
	public final RootContext root() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4512258281439232L) != 0)) {
				{
				setState(92);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final PclassContext pclass() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 272678883688448L) != 0)) {
				{
				{
				setState(165);
				pclass_body();
	...
	public final ErrorContext error() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 135108016738531664L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Effect_callContext effect_call() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 135108016738531664L) != 0)) {
				{
				setState(318);
				expr(0);
				setState(323);
		...
		try {
			...
			case 15:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 135107993116088336L) != 0) );
				setState(384);
				match(RCURLY);
				}
				break;
			case 16:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 135108021033498960L) != 0) );
				setState(393);
				match(RCURLY);
				}
				break;
