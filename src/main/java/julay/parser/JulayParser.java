...
public class JulayParser extends Parser {
	...
	public static final int
		...
		VAR=41, CONSTRUCTOR=42, TRANSITION=43, SERVICE=44, CONSUMER=45, GUARD=46, 
		TRANSIT=47, ERROR=48, EFFECT=49, FUN=50, REAL=51, INT=52, ID=53, STRING=54, 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'o-class'", "'proc'", "'program'", "'spec'", "'var'", "'constructor'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"IMPORT", "PCLASS", "OCLASS", "PROC", "PROGRAM", "SPEC", "VAR", "CONSTRUCTOR", 
	...
	public final RootContext root() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1128064570359808L) != 0)) {
				{
				setState(92);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final ErrorContext error() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 33777004184664400L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Effect_callContext effect_call() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 33777004184664400L) != 0)) {
				{
				setState(318);
				expr(0);
				setState(323);
		...
		try {
			...
			case 14:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 33776998279026704L) != 0) );
				setState(382);
				match(RCURLY);
				}
				break;
			case 15:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 33777005258406224L) != 0) );
				setState(391);
				match(RCURLY);
				}
				break;
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			setState(484);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 24769797950543872L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
